...
ActiveRecord::Schema.define(version: 20_170_415_024_952) do
  ...
  create_table 'oauth_access_grants', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.text     'redirect_uri', limit: 65_535, null: false
    t.datetime 'created_at', null: false
  ...
  create_table 'topics', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.text     'body',             limit: 65_535, null: false, comment: '原始数据'
    t.text     'body_html',        limit: 65_535,              comment: 'Markdown格式数据'
